...
// jmethodID get_declared_field;
    ...
    jobject LoadMethod(JNIEnv *env, jobject class_loader, jclass clazz, std::string_view name,
                       std::vector<std::string_view> &params) {
        auto java_name = env->NewStringUTF(name.data());
        auto lang_class = env->FindClass("java/lang/Class");
        auto params_class = env->NewObjectArray(static_cast<int>(params.size()), lang_class,
                                                nullptr);
...
Java_cat_app_bicleaner_utils_DexHelper_findMethodUsingString(
...
Java_cat_app_bicleaner_utils_DexHelper_load(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_cat_app_bicleaner_utils_DexHelper_findMethodInvoking(
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_cat_app_bicleaner_utils_DexHelper_findMethodInvoked(
        JNIEnv *env, jobject thiz, jlong method_index, jlong return_type,
        jshort parameter_count, jstring parameter_shorty, jlong declaring_class,
        jlongArray parameter_types, jlongArray contains_parameter_types,
        jintArray dex_priority, jboolean find_first) {
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_cat_app_bicleaner_utils_DexHelper_findMethodSettingField(
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_cat_app_bicleaner_utils_DexHelper_findMethodGettingField(
        JNIEnv *env, jobject thiz, jlong field_index, jlong return_type,
        jshort parameter_count, jstring parameter_shorty, jlong declaring_class,
        jlongArray parameter_types, jlongArray contains_parameter_types,
        jintArray dex_priority, jboolean find_first) {
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_cat_app_bicleaner_utils_DexHelper_findField(JNIEnv *env, jobject thiz,
                                                 jlong type,
...
Java_cat_app_bicleaner_utils_DexHelper_decodeMethodIndex(JNIEnv *env,
                                                         jobject thiz,
                                                         jlong method_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
extern "C" JNIEXPORT jobject JNICALL
Java_cat_app_bicleaner_utils_DexHelper_decodeFieldIndex(JNIEnv *env,
                                                        jobject thiz,
                                                        jlong field_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
extern "C" JNIEXPORT jlong JNICALL
Java_cat_app_bicleaner_utils_DexHelper_encodeClassIndex(JNIEnv *env,
                                                        jobject thiz,
                                                        jclass clazz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
extern "C" JNIEXPORT jlong JNICALL
Java_cat_app_bicleaner_utils_DexHelper_encodeFieldIndex(JNIEnv *env,
                                                        jobject thiz,
                                                        jobject field) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
extern "C" JNIEXPORT jlong JNICALL
Java_cat_app_bicleaner_utils_DexHelper_encodeMethodIndex(JNIEnv *env,
                                                         jobject thiz,
                                                         jobject method) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
Java_cat_app_bicleaner_utils_DexHelper_decodeClassIndex(JNIEnv *env,
                                                        jobject thiz,
                                                        jlong class_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
Java_cat_app_bicleaner_utils_DexHelper_close(JNIEnv *env, jobject thiz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *) {
    ...
    jclass helper = env->FindClass("cat/app/bicleaner/utils/DexHelper");
...
extern "C" JNIEXPORT void JNICALL
Java_cat_app_bicleaner_utils_DexHelper_createFullCache(JNIEnv *env,
                                                       jobject thiz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
